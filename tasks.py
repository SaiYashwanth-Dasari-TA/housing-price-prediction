...
def complexity_score(c):
    ...
    import subprocess
    try:
        result = subprocess.run(["radon", "cc", "--total-average", "./production"], capture_output=True, text=True)
        complexity_score = result.stdout.strip()
        print(f"Complexity Score: {complexity_score}")
    except FileNotFoundError:
        print("Radon is not installed. Please make sure to install it using 'pip install radon'.")


_create_task_collection("complexity", complexity_score)
